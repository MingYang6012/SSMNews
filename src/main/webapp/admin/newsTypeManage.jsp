...
<script type="text/javascript">
	...
	function openNewsTypeModifyDialog(){
		var selectedRows=$("#dg").datagrid("getSelections");
		 ...
		 $("#fm").form("load",row);
		 url="${pageContext.request.contextPath}/admin/newsType/save?id="+row.id;
	 }
...
<table id="dg" title="新闻类别管理" class="easyui-datagrid"
   fitColumns="true" pagination="true" rownumbers="true"
   url="${pageContext.request.contextPath}/admin/newsType/list" fit="true" toolbar="#tb">
   <thead>
   	<tr>
   		<th field="cb" checkbox="true" align="center"></th>
   		<th field="id" width="20" align="center">编号</th>
   		<th field="typeName" width="100" align="center">新闻类型名称</th>
 ...
 <div id="tb">
 	<div>
 		...
 		<a href="javascript:openNewsTypeModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
