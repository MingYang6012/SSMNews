...
<head>
    ...
    <script type="text/javascript">
        ...
        function formatNewsTitle(val,row){
            if(val==null){
                return "<font color='red'>该新闻已被删除！</font>";
            }else{
                return "<a target='_blank' href='${pageContext.request.contextPath}/news/articles/"+val.id+".html'>"+val.title+"</a>";
            }
        }
...
<table id="dg" title="评论审核管理" class="easyui-datagrid"
    ...
    <tr>
        ...
        <th field="news" width="200" align="center" formatter="formatNewsTitle">新闻标题</th>
